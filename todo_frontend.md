...
- [ ] **Hero Section Animation**: Update the "Fund the future" text in `HeroSection.tsx` to cycle through:
    ...
    - `Build the future`
    - `Scale the future`
- [ ] **Text Transition Effect**: The scrambled text currently works on hover; update it so it automatically cycles through the different text phrases ("Fund...", "Build...", "Scale...") using the text scramble transition.
...
- [ ] **Home Page Structure Redesign**: 
  ...
  - Restructure the main page layout to the following order:
    ...
    4. Footer
- [ ] **Explore Campaigns Navigation**: The "Explore Campaigns" links/buttons should redirect smoothly to the "Explore Campaigns" section just below "How it works", utilizing a smooth scroll effect that travels all the way down to it.
