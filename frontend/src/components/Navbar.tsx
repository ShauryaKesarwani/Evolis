  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        {/* Action */}
        <button className="px-6 py-2.5 rounded-full bg-[#111111] text-[#FCFAF6] text-sm font-semibold font-mono hover:bg-accent hover:text-[#111111] transition-all border border-transparent hover:border-[#111111] shadow-md hover:shadow-lg hover:-translate-y-0.5 transform active:translate-y-0 active:shadow-none">
          Connect Wallet
        </button>
      </div>
    </nav>
